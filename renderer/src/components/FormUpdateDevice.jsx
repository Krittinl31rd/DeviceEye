...
const FormUpdateDevice = ({ formDevice, setFormDevice }) => {
  if (!formDevice) return null;
          ...
          >
            <div>
              ...
              <input
                ...
                value={tag.unitId}
                onChange={(e) =>
                  handleTagChange(idx, "unitId", Number(e.target.value))
                }
                className="input input-sm"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                max={4}
                onChange={(e) =>
                  handleTagChange(idx, "fc", Number(e.target.value))
                }
                className="input input-sm"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                value={tag.start}
                onChange={(e) =>
                  handleTagChange(idx, "start", Number(e.target.value))
                }
                className="input input-sm"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                value={tag.length}
                onChange={(e) =>
                  handleTagChange(idx, "length", Number(e.target.value))
                }
                className="input input-sm"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                value={tag.interval}
                onChange={(e) =>
                  handleTagChange(idx, "interval", Number(e.target.value))
                }
                className="input input-sm"
              />
            </div>
